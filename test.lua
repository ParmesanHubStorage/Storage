...
loadstring(game:HttpGet(("https://raw.githubusercontent.com/ParmesanHubStorage/Storage/main/Keys.lua"),true))()
...
function CheckKeys(EnteredKey)
	for i,v in pairs(PremiumKeys) do
...
--main
if (isfile("ParmesanHubKey.txt") and CheckKeys(readfile("ParmesanHubKey.txt"))) then
	...
	function CreateKeySystem()
		...
		do 
			...
			KeySystem["7"].FocusLost:Connect(function()
				if CheckKeys(KeySystem["7"].Text) == true then
					loadstring(game:HttpGet(("https://raw.githubusercontent.com/ParmesanHubStorage/Storage/main/test2.lua"),true))()
